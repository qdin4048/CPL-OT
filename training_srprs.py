...
language = 'en_fr' # en_fr | en_de
prior_align_percentage = 0 # 0% of seeds
#%%
e1 = 'data/' + language + '_15k_V1/ent_ids_1'
e2 = 'data/' + language + '_15k_V1/ent_ids_2'
ill = 'data/' + language + '_15k_V1/ref_ent_ids'
kg1 = 'data/' + language + '_15k_V1/triples_1'
kg2 = 'data/' + language + '_15k_V1/triples_2'
...
import json
lang = language[-2:]
with open(file='data/en_' + lang + '_15k_V1/' + lang + '_bert300.json', mode='r', encoding='utf-8') as f:
